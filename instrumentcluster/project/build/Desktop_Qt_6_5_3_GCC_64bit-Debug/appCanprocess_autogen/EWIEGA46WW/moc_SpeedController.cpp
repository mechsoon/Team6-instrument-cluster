...
static constexpr auto qt_meta_stringdata_CLASSSpeedControllerENDCLASS = QtMocHelpers::stringData(
    "SpeedController",
    "speedChanged",
    "",
    "updateSpeed",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSSpeedControllerENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSSpeedControllerENDCLASS_t qt_meta_stringdata_CLASSSpeedControllerENDCLASS = {
    {
        QT_MOC_LITERAL(0, 15),  // "SpeedController"
        QT_MOC_LITERAL(16, 12),  // "speedChanged"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 11),  // "updateSpeed"
        QT_MOC_LITERAL(42, 5)   // "speed"
    },
    "SpeedController",
    "speedChanged",
    "",
